...
export interface SolverSolveRequest {
    ...
    waitTime: number;
    /**
     * @generated from protobuf field: bool use_cache = 5;
     */
    useCache: boolean;
    /**
     * @generated from protobuf field: uint32 cache_pull_interval = 6;
     */
    cachePullInterval: number;
    /**
...
export interface SolverStepByStepResponse {
    ...
    /**
     * @generated from protobuf field: repeated solver.v1.RotatedPiece max_board = 2;
     */
    maxBoard: RotatedPiece[];
    /**
     * @generated from protobuf field: uint32 steps = 3;
     */
    steps: number;
    /**
     * @generated from protobuf field: double time = 4;
     */
    time: number;
    /**
    ...
    /**
     * @generated from protobuf field: double boards_per_second = 6;
     */
...
class SolverSolveRequest$Type extends MessageType<SolverSolveRequest> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 wait_time */ 4:
                    ...
                    break;
                case /* bool use_cache */ 5:
                    message.useCache = reader.bool();
                    break;
                case /* uint32 cache_pull_interval */ 6:
                    message.cachePullInterval = reader.uint32();
                    break;
                case /* repeated uint32 solve_path */ 7:
    ...
    internalBinaryWrite(message: SolverSolveRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.useCache !== false)
            writer.tag(5, WireType.Varint).bool(message.useCache);
        /* uint32 cache_pull_interval = 6; */
        if (message.cachePullInterval !== 0)
            writer.tag(6, WireType.Varint).uint32(message.cachePullInterval);
        /* repeated uint32 solve_path = 7; */
        if (message.solvePath.length) {
            writer.tag(7, WireType.LengthDelimited).fork();
            for (let i = 0; i < message.solvePath.length; i++)
...
class SolverStepByStepResponse$Type extends MessageType<SolverStepByStepResponse> {
    constructor() {
        super("solver.v1.SolverStepByStepResponse", [
            ...
            { no: 2, name: "max_board", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => RotatedPiece },
            { no: 3, name: "steps", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 4, name: "time", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 5, name: "boards_analyzed", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "boards_per_second", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated solver.v1.RotatedPiece rotated_pieces */ 1:
                    ...
                    break;
                case /* repeated solver.v1.RotatedPiece max_board */ 2:
                    message.maxBoard.push(RotatedPiece.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* uint32 steps */ 3:
                ...
                case /* uint32 boards_analyzed */ 5:
                    ...
                    break;
                case /* double boards_per_second */ 6:
    ...
    internalBinaryWrite(message: SolverStepByStepResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated solver.v1.RotatedPiece max_board = 2; */
        for (let i = 0; i < message.maxBoard.length; i++)
            RotatedPiece.internalBinaryWrite(message.maxBoard[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* uint32 steps = 3; */
        if (message.steps !== 0)
            writer.tag(3, WireType.Varint).uint32(message.steps);
        /* double time = 4; */
        if (message.time !== 0)
        ...
        if (message.boardsPerSecond !== 0)
            writer.tag(6, WireType.Bit64).double(message.boardsPerSecond);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
