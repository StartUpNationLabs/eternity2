// V175 GAUNTLET — V155 prior-beam with REVERSE / ZIGZAG / SPIRAL scans.
//
...
fn main() {
    ...
    if let Some(b) = best {
        println!("{{\"profile\":\"v175_gauntlet\",\"scan\":\"{scan_mode}\",\"beam_width\":{beam_width},\"prior\":{},\"elapsed_ms\":{},\"beam_final\":{},\"best_score\":{}}}",
        ...
        println!("{{\"profile\":\"v175_gauntlet\",\"elapsed_ms\":{},\"best_score\":0,\"error\":\"empty_beam\"}}",
            elapsed.as_millis());
    }
}
