...
fn run_one_arm(
    ...
    let (alns_board, _polish_gain) = polish_rotations(puzzle, &alns_board, &pinned_set_polish);
    let (alns_board, _swap_gain) = piece_swap_hillclimb(puzzle, &alns_board, &pinned_set_polish);
