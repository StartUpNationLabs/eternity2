...
|  35 |             — |       — | Discovered **pin_hints duplicate-piece bug** in vanilla_fast snapshots — affected ~98% of sweep snapshots, retracted vol-34 records + first vol-35 "7th basin" claim. Fix shipped (3 save paths). Deep_458_basin lottery on vol-32's clean partial: 1×458 (byte-identical to vol-32, reproduce), 2×457 (new satellites of 458 family), still no 459. 458 record stands. [[vol-35]]. |  |
