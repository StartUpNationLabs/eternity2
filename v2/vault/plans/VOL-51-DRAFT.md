# Vol-51 draft plan (2026-05-15) — written ahead of vol-50 close

This plan exists BEFORE vol-50 closes to ensure the autonomous loop
has a clear next step regardless of vol-50 outcome.

## Pre-decision: vol-50 outcome contingencies

### Branch A: vol-50 blackwood_raw+MRV 1h × 4 produces ≥ 458
...
4. Write vol-51 session-note as the second record-break vol of the
   project (after vol-32).

### Branch B: vol-50 blackwood_raw+MRV plateaus at 457 (most likely)

Most likely outcome. 1h is a 6× scale-up from vol-32's 10min and
single-thread vs vol-50's effective 12min/seed. Returns may be
sub-linear.
