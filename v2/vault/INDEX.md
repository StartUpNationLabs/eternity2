...
|  50 |             — |       — | **Vol-50 opening**: Q-learning value-order PoC. Pivot from ES-collapse diagnosis. Reuse vol-29 v3 GNN architecture, swap classification head for scalar Q output, train against TD targets from observed engine rewards. 6×6 gate first, then canonical. [[plans/CURRENT-VOL\|CURRENT-VOL]] |  |
