...
const DraggablePiece: FC<DraggablePieceProps> = ({ 
    piece, 
    isDraggable = false,
    rotation,
    onRotate,
    ...
    return (
        <Box 
            ...
            sx={{ 
                width: '100%', 
                height: '100%',
                cursor: isDraggable ? 'grab' : 'pointer', // Always pointer to indicate interactive
                '&:active': {
...
// Attach the BoardDropZone component to the DraggablePiece
